...
export default function ContentTab({ 
  ...
  const generateImageRecommendations = () => {
    ...
    } else if (imageData.count && imageData.withoutAltCount > 0) {
      recommendations.push(`Add alt text to ${imageData.withoutAltCount} image(s) for better accessibility and SEO.`);
    }
    ...
    } else if (imageData.count > 0 && imageData.optimizedCount < imageData.count) {
          ...
          {contentData?.headingStructure ? (
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-gray-700">
                  {contentData.headingStructure.h2Count}
                </span>
              </div>
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-gray-700">
                  {contentData.headingStructure.h3Count}
                </span>
              </div>
