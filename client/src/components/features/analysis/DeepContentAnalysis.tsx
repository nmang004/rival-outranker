        ...
        <Tabs defaultValue="annotated" className="w-full">
          ...
          <TabsContent value="annotated" className="space-y-4">
                  ...
                  <CollapsibleContent>
                    ...
                    {data.annotatedContent.introduction.annotations.length > 0 ? (
                      <div className="mt-3 space-y-3">
                        ...
                        {data.annotatedContent.introduction.annotations.map((annotation: any, index: number) => (
            ...
            <div className="mb-4">
              ...
              {data.annotatedContent.mainContent.map((section: any, idx: number) => {
                    ...
                    <Collapsible>
                      ...
                      <CollapsibleContent>
                        ...
                        {section.annotations.length > 0 ? (
                          <div className="mt-3 space-y-3">
                            <h5 className="text-sm font-medium">Suggested Improvements:</h5>
                            {section.annotations.map((annotation: any, index: number) => (
                              <div key={index} className="border-l-2 pl-3 py-1 text-sm"
                                style={{ 
                                  borderColor: annotation.severity === 'high' ? '#ef4444' : 
                                              annotation.severity === 'medium' ? '#f97316' : '#84cc16'
                ...
                <Collapsible defaultOpen>
                  ...
                  <CollapsibleContent>
                    ...
                    {data.annotatedContent.conclusion.annotations.length > 0 ? (
                      <div className="mt-3 space-y-3">
                        <h5 className="text-sm font-medium">Suggested Improvements:</h5>
                        {data.annotatedContent.conclusion.annotations.map((annotation: any, index: number) => (
                          <div key={index} className="border-l-2 pl-3 py-1 text-sm"
                            style={{ 
                              borderColor: annotation.severity === 'high' ? '#ef4444' : 
                                        annotation.severity === 'medium' ? '#f97316' : '#84cc16'
                ...
                <div className="bg-slate-50 p-2 rounded">
                  <div className="flex items-center">
                    <span className="bg-red-100 text-red-800 px-1.5 py-0.5 rounded mr-1.5">
                      {data.annotatedContent.introduction.annotations.filter((a: any) => a.type === 'structure').length +
                       data.annotatedContent.mainContent.reduce((sum: number, section: any) => 
                          sum + section.annotations.filter((a: any) => a.type === 'structure').length, 0) +
                       data.annotatedContent.conclusion.annotations.filter((a: any) => a.type === 'structure').length}
                    </span>
                ...
                <div className="bg-slate-50 p-2 rounded">
                  <div className="flex items-center">
                    <span className="bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded mr-1.5">
                      {data.annotatedContent.introduction.annotations.filter((a: any) => a.type === 'readability').length +
                       data.annotatedContent.mainContent.reduce((sum: number, section: any) => 
                          sum + section.annotations.filter((a: any) => a.type === 'readability').length, 0) +
                       data.annotatedContent.conclusion.annotations.filter((a: any) => a.type === 'readability').length}
                    </span>
                ...
                <div className="bg-slate-50 p-2 rounded">
                  <div className="flex items-center">
                    <span className="bg-green-100 text-green-800 px-1.5 py-0.5 rounded mr-1.5">
                      {data.annotatedContent.introduction.annotations.filter((a: any) => a.type === 'semantics').length +
                       data.annotatedContent.mainContent.reduce((sum: number, section: any) => 
                          sum + section.annotations.filter((a: any) => a.type === 'semantics').length, 0) +
                       data.annotatedContent.conclusion.annotations.filter((a: any) => a.type === 'semantics').length}
                    </span>
                ...
                <div className="bg-slate-50 p-2 rounded">
                  <div className="flex items-center">
                    <span className="bg-purple-100 text-purple-800 px-1.5 py-0.5 rounded mr-1.5">
                      {data.annotatedContent.introduction.annotations.filter((a: any) => a.type === 'engagement').length +
                       data.annotatedContent.mainContent.reduce((sum: number, section: any) => 
                          sum + section.annotations.filter((a: any) => a.type === 'engagement').length, 0) +
                       data.annotatedContent.conclusion.annotations.filter((a: any) => a.type === 'engagement').length}
                    </span>
