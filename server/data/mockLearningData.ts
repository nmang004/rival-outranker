...
export const mockModules = [
  {
    ...
    imageUrl: "/images/modules/seo-fundamentals.jpg",
    difficulty: "Beginner",
    estimatedTime: 90,
    prerequisiteIds: [],
    sortOrder: 1,
  ...
  },
  {
    ...
    imageUrl: "/images/modules/keyword-research.jpg",
    difficulty: "Beginner",
    estimatedTime: 120,
    prerequisiteIds: [1],
    sortOrder: 2,
  ...
  },
  {
    ...
    imageUrl: "/images/modules/on-page-seo.jpg",
  ...
  },
  {
    ...
    imageUrl: "/images/modules/technical-seo.jpg",
    difficulty: "Intermediate",
    estimatedTime: 180,
    prerequisiteIds: [1],
    sortOrder: 4,
  ...
  },
  {
    ...
    imageUrl: "/images/modules/link-building.jpg",
    difficulty: "Advanced",
    estimatedTime: 210,
    prerequisiteIds: [1, 3],
    sortOrder: 5,
  ...
  },
  {
    ...
    imageUrl: "/images/modules/local-seo.jpg",
    difficulty: "Intermediate",
    estimatedTime: 120,
  ...
  },
  {
    ...
    imageUrl: "/images/modules/ecommerce-seo.jpg",
    difficulty: "Advanced",
    estimatedTime: 240,
  ...
  },
  {
    ...
    imageUrl: "/images/modules/seo-analytics.jpg",
    difficulty: "Intermediate",
    estimatedTime: 150,
    prerequisiteIds: [1],
    sortOrder: 8,
  ...
  },
  {
    ...
    imageUrl: "/images/modules/mobile-seo.jpg", 
    difficulty: "Advanced",
    estimatedTime: 180,
    prerequisiteIds: [1, 4],
    sortOrder: 9,
...
export const mockLearningPaths = [
  {
    ...
    imageUrl: "/images/paths/seo-essentials.jpg",
  ...
  },
  {
    ...
    imageUrl: "/images/paths/technical-seo.jpg",
  ...
  },
  {
    ...
    imageUrl: "/images/paths/ecommerce-seo.jpg",
...
export function generateProgressSummary(userId: string) {
  // Filter progress for this user
  const userProgressData = mockUserProgress.filter(p => p.userId === userId);
  
  // Get completed lessons
  const completedLessons = userProgressData.filter(p => p.status === 'completed');
